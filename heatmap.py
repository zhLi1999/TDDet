...
def get_params():
    params = {
        'weight': 'runs/train/0.95(V8)/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfgD:\code\ultralytics-A100\runs\train\0.955\weights\best.pt
        # 'weight': 'D:/code/ultralytics-A100/yolov8s.pt',
        'device': 'cuda:0',
        'method': 'GradCAM', # GradCAMPlusPlus, GradCAM, XGradCAM,  LayerCAM, RandomCAM,HiResCAM,  EigenGradCAM,EigenCAM,
        'layer': [13],    #最多到13层4
...
if __name__ == '__main__':
    ...
    # model(r'C:/Users/lzh/Desktop/Original dataset/Tea exobasidium blight/DSC_3100.jpg', 'result')
    model(r'D:/code/ultralytics-A100/dataset/chayev11/train700/images/20150509-DSC_0012_IJFR_jpg.rf.388ab81b31110848203e233b8736fc9f.jpg', 'result')
    # model(r'D:/code/ultralytics-A100/dataset/chayev11/train700/images', 'result')C:\Users\lzh\Desktop\Original dataset\Tea algae leaf spot